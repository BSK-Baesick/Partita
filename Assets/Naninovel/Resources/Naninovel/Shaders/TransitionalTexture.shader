...
Shader "Naninovel/TransitionalTexture"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                // Using MainTexCoord for TransitionTex, otherwise won't transition properly inside uGUI canvas renderer (something with shader channels).
                fixed4 color = ApplyTransitionEffect(_MainTex, vertexOutput.MainTexCoord, _TransitionTex, vertexOutput.MainTexCoord, _TransitionProgress, _TransitionParams, _RandomSeed, _CloudsTex, _DissolveTex);
